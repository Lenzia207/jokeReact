        ...
        <Container className={classes.paper}>
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
               <Container>
                ...
                <Typography variant="subtitle1"> You can also {currentId ? 'edit' : 'submit'} your own fancy jokes: </Typography>
                </Container>
                ...
                <Container  className={classes.btn}>
                    ...
                    <Button className={classes.btnClear}variant="contained" color="secondary" size="small" fullWidth onClick={clear}>Clear</Button>
